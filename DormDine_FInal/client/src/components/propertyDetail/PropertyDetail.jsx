...
const PropertyDetail = () => {
  ...
  const handleContactOwner = async (e) => {
    ...
    emailjs.sendForm("service_9wcogpe", "template_2hf0m2s", formRef.current, '5Q_Va8KqmXe4DZGr3')
      .then((result) => {
        handleCloseForm()
        setSuccess(true)
        setTimeout(() => {
        ...
        <div className={classes.right}>
          ...
          <div className={classes.details}>
            ...
            <div className={classes.moreDetails}>
              ...
              <span>{propertyDetail?.sqmeters} square feet <FaSquareFull className={classes.icon} /></span>
            </div>
          </div>
